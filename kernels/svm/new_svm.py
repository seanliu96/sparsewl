...
def main():
    ...
    algorithms = ["WL1", "GR", "SP", "WLOA", "WL2", "LWL2", "LWLP2", "DWL2", "LWL3", "LWLP3", "DWL3"]
    ...
    for a in algorithms:
        for d, use_labels in dataset:
            ...
            if gram_matrices != []:
                ...
                print(a, d, acc_train, std_train, acc, std)
    ...
    for name in ["Yeast", "YeastH", "UACC257", "UACC257H", "OVCAR-8", "OVCAR-8H"]:
        for algorithm in ["LWL2", "LWLP2", "WL"]:
            ...
            acc, std = linear_svm_evaluation(all_feature_matrices, classes, num_repetitions=3, all_std=False)
            print(name, algorithm, acc, std)
